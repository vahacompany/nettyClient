 ...
 */
public final class TelnetClient2 {
	 ...
	 * @param pw
	 */
	private TelnetClient2(String host, int port, String user, String pw) {
		this.host = host;
		this.port = port;
		this.user = user;
		this.pw = pw;
	...
	private Channel initConnection(BlockingQueue<String> queue) {
		...
		try {
			...
			b.group(group).channel(NioSocketChannel.class).handler(new TelnetClientInitializer2(user, pw, queue));
	...
	public static void main(String[] args) throws Exception {
		final TelnetClient2 telnetClient = new TelnetClient2("127.0.0.1", 8023, "test", "test");
